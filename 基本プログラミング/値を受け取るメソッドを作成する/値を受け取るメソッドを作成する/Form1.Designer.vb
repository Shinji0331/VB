...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Size = New System.Drawing.Size(401, 12)
        Me.Label1.TabIndex = 0
        Me.Label1.Text = "文字列「Param」を引数としてサブプロシージャに渡して、変更した結果を表示します。"
        '
        'Label2
        '
        ...
        'Button1
        '
        Me.Button1.Location = New System.Drawing.Point(22, 126)
